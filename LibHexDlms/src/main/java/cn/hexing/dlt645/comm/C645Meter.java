...
public class C645Meter extends CommOpticalSerialPort implements ICommunicator {
    ...
    public C645Meter(String c645Address) {
    ...
    public C645Meter( byte[] c645AddressBytes) {
