...
public class AppManager {
    ...
    static void add(Application app) {
        ReflectUtil.setMember(Application.class, app, "mComponentCallbacks", new HexArrayList(mainApp));
        ReflectUtil.setMember(Application.class, app, "mActivityLifecycleCallbacks", new HexArrayList(mainApp));
        ReflectUtil.setMember(Application.class, app, "mAssistCallbacks", new HexArrayList(mainApp));
        apps.add(app);
    }
