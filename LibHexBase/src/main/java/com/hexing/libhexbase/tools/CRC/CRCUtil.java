package com.hexing.libhexbase.tools.CRC;
...
public class CRCUtil {
    ...
    public static String getCRC16(String str) {
        byte[] data = StringUtil.hexToByte(str.toUpperCase());
        int StartIndex = 0;
        ...
        RtnByte[0] = (byte) Temp1;
        RtnByte[1] = (byte) Temp2;
        return StringUtil.bytesToHexString(RtnByte);
    }
     ...
     *
     * @param data 原字符串
     * @param num  异或数据 16进制 如 0X33
     * @return 运算之后字符串
     */
    public static String exclusiveOrOperation(String data, int num) {
        ...
        int j = data.length() / 2;
        while (i < j) {
            stringBuilder.append(StringUtil.padRight(String.valueOf(num ^ Integer.parseInt(data.substring(i * 2, 2 + i * 2), 16)), 2, '0'));
            i++;
        }
        return stringBuilder.toString();
    }
